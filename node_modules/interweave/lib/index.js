...
function Element(_ref) {
  ...
  return selfClose ? /*#__PURE__*/React__default['default'].createElement(Tag, attributes) : /*#__PURE__*/React__default['default'].createElement(Tag, attributes, children);
}
    ...
    Array.from(parentNode.childNodes).forEach(function (node) {
      ...
      if (node.nodeType === ELEMENT_NODE) {
        ...
        if (!(noHtml || noHtmlExceptMatchers && tagName !== 'br') && _this3.isTagAllowed(tagName) && (allowElements || _this3.canRenderChild(parentConfig, config))) {
          ...
          content.push( /*#__PURE__*/React__default['default'].createElement(Element, _extends({}, elementProps, {
            key: _this3.keyIndex
